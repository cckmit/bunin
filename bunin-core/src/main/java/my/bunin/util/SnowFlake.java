...
public class SnowFlake {
  ...
  public static final long DEFAULT_WORKER_ID_BITS = 5L;
  public static final long DEFAULT_DATA_CENTER_ID_BITS = 5L;
  ...
  public SnowFlake(long workerId, long dataCenterId) {
    this(workerId, dataCenterId, null, null, null);
  }

  /**
   * snow flake constructor.
   */
  public SnowFlake(long workerId, long dataCenterId, Long workerIdBits,
    ...
    this.dataCenterIdBits = Optional.ofNullable(dataCenterIdBits)
        .orElse(DEFAULT_DATA_CENTER_ID_BITS);
